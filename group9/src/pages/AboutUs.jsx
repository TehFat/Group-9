...
// break out for readability and reusability
const TeamMember = ({ name, github }) => (
  <li>
    {name}
    <a
      href={github}
...
const AboutUs = () => (
  <main className="about-us-container">
    ...
    <Section title="Our Story">
      <p>
        MovieMagic was born out of a passion for cinema and a desire to
        revolutionize how people discover and enjoy movies. Founded in 2025 by a
        team of film enthusiasts and tech innovators, we set out to create an
        app that brings the magic of movies to your fingertips.
      </p>
    </Section>

    <Section title="Our Mission">
      <p>
        At MovieMagic, our mission is to enhance the movie-watching experience
        by providing a platform that connects film lovers with their perfect
        next watch. We strive to make movie discovery an exciting journey,
        powered by cutting-edge technology and a deep love for cinema.
      </p>
    </Section>
    ...
    <Section title="Meet the Team">
      <ul>
        <TeamMember name="Klejda Mama" github="https://github.com/klejda59" />
        <TeamMember
          name="Tahir Mehmood"
          github="https://github.com/tahirmehmood22"
        />
        <TeamMember
          name="Mehran Ahmadnia"
          github="https://github.com/gonibarjin"
        />
        <TeamMember name="Tehreem Fatima" github="https://github.com/tehfat" />
    ...
    <Section title="Looking Ahead">
      <p>
        We're constantly evolving and improving MovieMagic. Our vision for the
        future includes expanding our global movie database, introducing virtual
        reality previews, and creating a vibrant community of movie enthusiasts.
      </p>
    </Section>
  </main>
);
